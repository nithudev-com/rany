      ...
      <div className="invoice-body">
        <div className="invoice-container">
          ...
          <div style={{ marginTop: '80px', textAlign: 'center', borderTop: '1px solid #e2e8f0', paddingTop: '24px' }}>
            <p style={{ margin: 0, color: '#94a3b8', fontSize: '12px' }}>Thank you for your business. For any inquiries regarding this invoice, please contact support@speedcommerce.com.</p>
          </div>
